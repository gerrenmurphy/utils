# This was taken from PowerSploit, but modified to clean up the output of the records
# where the 4th octet was truncated after .9
# Example below
# 50.50.50.8 static-50-50-50-8.arr01.waus.wi.frontiernet.net
# 50.50.50.9 static-50-50-50-9.arr01.waus.wi.frontiernet.net
# 50.50.5... static-50-50-50-10.arr01.waus.wi.frontiernet...
# 50.50.5... static-50-50-50-11.arr01.waus.wi.frontiernet...
    ...
    PROCESS {
        ...
        Parse-IPList $IpRange | ForEach-Object {
            try {
                ...
                write-host $Temp.AddressList $tab $Temp.HostName
            } 
